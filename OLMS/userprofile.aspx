<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="OLMS.userprofile" %>
    ...
    <div class=" col-md-6">
            <div class="card">
                    ...
                    <div class="card-img-top">
                        <div class="col ">                            
                                <img src="images/user.jpg" style="width:30%" />                                                  
                        </div>
                    </div>

            <div class="card-body">
                     <div class="row">
                      <h3 class="text-primary card-title">Your Profile</h3>
                         <div class="col-md-6">
                    ...
                    <div class="row">                      
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="form-group">
                         <asp:Button class="btn btn-success btn-lg btn-block form-control" Text="Update" ID="Login" runat="server"/>
                          </div>
     ...
     <div class="col-md-6">
            <div class="card">
            <div class="card-body">
            <h3 class="card-title text-primary">your issued books</h3>
