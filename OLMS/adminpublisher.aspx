<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="adminpublisher.aspx.cs" Inherits="OLMS.adminpublisher" %>
            ...
            <div class="col-md-6">
                <div class="card" style="border:solid 1px #c3c3c3;padding:20px;">
                    <div class="card-header text-center">
                        <h3 class="card-title text-primary">Publisher Details</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="publisher_id" runat="server" placeholder="Publisher Id"></asp:TextBox>
                                </div>
                            </div>
           ...
           <%-- second section--%>
                ...
                <div class="card" style="border:solid 1px #c3c3c3;padding:20px;">
                    <div class="card-header">
                        <h3 class="card-title text-primary text-center">Publisher List</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <asp:DataGrid runat="server" CssClass="table table-striped table-bordered"> </asp:DataGrid>
                            </div>
                        </div>
                    </div>
                </div>
